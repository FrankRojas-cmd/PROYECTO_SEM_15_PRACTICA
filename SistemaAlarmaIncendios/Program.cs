    ...
    class Program
    {
        ...
        static void MostrarDetallePiso(int numPiso, int tempActual, AlarmManager alarma) // Método para mostrar los detalles del piso seleccionado
        {
            ...
            if (tempActual >= 81) // Verificar si la temperatura actual es igual o superior a 81°C
            {
                ...
                Console.WriteLine("\nAcciones realizadas:");
                Console.WriteLine("- Luces estroboscòpicas activadas");

                Console.WriteLine("- Activación de alarma sonora");
                Console.WriteLine("- Notificando personal de seguridad...");
                Console.WriteLine("- Nificando bomberos...");
                Console.WriteLine("- iniciando evacuaciòn...");
                Console.WriteLine("- seleccione (1) para activar los aspersores");
                int x = int.Parse(Console.ReadLine());
                switch (x)
                {
                    case 1: // Si el usuario selecciona activar aspersores
                        Console.WriteLine("- Aspersores activados. Iniciando rociado de agua en el piso.");
                        Console.WriteLine("- El agua se está dispersando para controlar el fuego.");
                        break;
                    default:
